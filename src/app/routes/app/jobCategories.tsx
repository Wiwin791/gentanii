...
import { ChevronLeft, ChevronRight, SquarePen, Trash2, Plus, Search, X } from 'lucide-react';
      ...
      <div className="flex gap-4">
        ...
        <div className="w-[250px] h-[275px] p-4 bg-gray-50 rounded-lg space-y-4">
          ...
          <div className="space-y-4">
            <div>
              <label htmlFor="categoryName" className="text-sm text-gray-600 block mb-1">
                Category Name
              </label>
              <Input
                id="categoryName"
            ...
            <div>
              <label htmlFor="categoryId" className="text-sm text-gray-600 block mb-1">
                Category ID
              </label>
              <Input
                id="categoryId"
