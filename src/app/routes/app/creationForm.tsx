...
import { Camera, Upload, FilePlus, Plus, Pencil, Trash2, Save } from 'lucide-react';
...
export const CreationForm = () => {
  const [processElements, setProcessElements] = React.useState<ProcessElement[]>([
    {
      id: 1,
          ...
          <div className="col-span-1 space-y-6">
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="text-sm text-gray-600 block mb-1">Revision</label>
                  <Input value="1.-" disabled className="bg-gray-50" />
                </div>
                <div>
                  <label className="text-sm text-gray-600 block mb-1">Man Power No.</label>
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs text-gray-500">Pastikan Foto Yang diambil terlihat jelas</p>
            </div>

            <div className="space-y-4">
              {['Location', 'Sub Location', 'Division', 'Departement', 'Section', 'Line'].map((label) => (
                <div key={label}>
            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              <Select defaultValue="gentan-1">
                ...
                <SelectContent>
                  ...
                  <SelectItem value="gentan-2">Gentan-A</SelectItem>
                </SelectContent>
              </Select>
              <Button className="bg-red-700 hover:bg-red-800">
                    ...
                    <TableRow key={element.id}>
                      {columns.map((column) => (
                        <TableCell key={column.id}>
                          {column.accessorKey
                            ? element[column.accessorKey as keyof ProcessElement]
                            : column.cell
